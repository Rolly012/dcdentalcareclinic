<?php
	...
	$rows = $model->count_OrgStructure();
	if (!empty($rows)) {
		foreach ($rows as $row) {
			$org_structure = $row['org_structure'] + 1;
		}
	}

	$rows = $model->count_feedbacks();
	if (!empty($rows)) {
		foreach ($rows as $row) {
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 heading-bx left">
							...
							<p>Check out the latest announcements, events, news and promotions here.</p>
						</div>
					</div>	
					<div class="row">
							...
							<div class="event-bx">
								...
								<div class="info-bx d-flex">
									...
									<div class="event-info">
										...
										<p><?php echo substr($row['details'], 0, 150); ?><a href="announcement-details?id=<?php echo $row['id']; ?>" style="color: <?php echo $primary_color; ?>;">.... See More</a></p>
									</div>
								</div>
							</div>
						</div>
